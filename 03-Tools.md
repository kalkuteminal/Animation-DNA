...
* **ADD ATTR** — create MtoA custom attributes (mColor, mMat, mDisp) on selected object shapes to store shading information in every asset for Arnold. See a [tutorial](06-Tutorials#multitexture-material) for explanation.
...
#### Attribute Manager
**ATM** button on DNA shelf. Attribute Manager allow to create, set and edit custom MtoA attributes on geometry shapes.
