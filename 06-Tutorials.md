...
[Search for](#developing-with-google): select all lights pymel. Go to the [first link](http://download.autodesk.com/global/docs/maya2013/ja_jp/PyMel/generated/functions/pymel.core.general/pymel.core.general.ls.html), at the bottom of the page in example section you will find a command which contain "light":  
